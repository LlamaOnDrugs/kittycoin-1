...
private slots:
    ...
    QString BuyKTY(QString OrderType, double Quantity, double Rate);
    QString SellKTY(QString OrderType, double Quantity, double Rate);
