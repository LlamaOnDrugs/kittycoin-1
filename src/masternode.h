...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 3500) (2, 10000) (3, 20000) (4, 40000); // 2500 - 5000 - 10000 - 20000

// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 33) (2, 130) (3, 300) (4, 620); // 25 - 60 - 140 - 300

//
// The Masternode Class. For managing the darksend process. It contains the input of the 1000 KTY, signature to prove
